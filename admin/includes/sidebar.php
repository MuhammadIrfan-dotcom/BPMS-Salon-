  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="all-order.php"><i class="fa fa-check-square-o nav_icon"></i>Order<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="all-order.php">All Order</a>
                </li>
                <li>
                  <a href="new-order.php">New Order</a>
                </li>
                <li>
                  <a href="accepted-order.php">Accepted Order</a>
                </li>
                <li>
                  <a href="rejected-order.php">Rejected Order</a>
                </li>
              </ul>
              <!-- //nav-second-level -->
            </li>
