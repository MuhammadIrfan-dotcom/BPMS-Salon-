...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2025 at 09:12 PM
...
(1, 'Admin', 'admin', 3061844238, 'mirfanmanzoor238@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2024-05-01 06:21:50');
...
INSERT INTO `tblcart` (`id`, `user_id`, `service_id`, `quantity`, `added_at`) VALUES
(1, NULL, 1, 1, '2025-01-13 20:11:21');
...
--
-- Table structure for table `tblodr`
--
...
CREATE TABLE `tblodr` (
  ...
  `payment_option` varchar(50) DEFAULT 'Cash on Delivery',
...
--
-- AUTO_INCREMENT for table `tblodr`
--
ALTER TABLE `tblodr`
